...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $state = isset($_POST["state"]) ? trim($_POST["state"]) : 0; // Default naar 0 (Klant)
    ...
    try {
        ...
        if ($email_exists) {
            ...
            header("location: ../../../../../../Project-p3-Escaperoom/Bestanden/inloggen_test/CRUD_users/01_read_client.php");
            exit();
        } else {
