...
<body>
    ...
    {foreach $products as $product}
        <li>
            ...
            <p class="prijs">Prijs: € {$product->getPrice()}</p>
            <p>{$product->getDescription()|truncate:50:"..."}</p>
            <p>Type: {$product->getType()|truncate:50:"..."}</p>

            <a href="index.php?page=product&id={$product->getId()}">Bekijk</a>
            <a href="index.php?action=add_to_cart&product_id={$product->getId()}">In winkelwagen</a>
        </li>
    {/foreach}
    </ul>
